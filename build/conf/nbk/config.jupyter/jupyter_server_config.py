...
#  Default: '/'
JUPYTERHUB_SERVICE_PREFIX = Path(os.getenv("JUPYTERHUB_SERVICE_PREFIX", default="/"))
c.ServerApp.base_url = str(JUPYTERHUB_SERVICE_PREFIX)
...
#  Choices: any of ['shake_256', 'sha3_512', 'sha1', 'md5', 'md5-sha1', 'sm3', 'blake2s', 'sha512_224', 'sha256', 'sha3_256', 'blake2b', 'sha3_384', 'sha512_256', 'sha384', 'shake_128', 'sha512', 'sha224', 'ripemd160', 'sha3_224']
#  Default: 'sha256'
...
#  Choices: any of ['sha512', 'blake2s', 'sha256', 'sha224', 'sha3_512', 'sha384', 'sha1', 'sha3_256', 'md5', 'sha3_224', 'blake2b', 'sha3_384']
#  Default: 'sha256'
