...
description: "Automated vulnerability, misconfiguration, and secret scans of the {{cookiecutter.project_name}} repository and container image."
listing:
  type: table
  contents:
    - scans/*.qmd
...
- **Container image** - the locally-built `katapult/{{cookiecutter.project_slug}}:latest` image (the artifact built from [build/Dockerfile](../build/Dockerfile)) is checked for OS package CVEs and vulnerabilities in bundled binaries with Trivy.
